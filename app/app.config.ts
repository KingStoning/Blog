...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ph:github-logo-bold', text: 'GitHub: KingStoning', url: 'https://github.com/KingStoning' },
		...
		nav: [
			...
			},
			{
				title: '社交',
				items: [
					{ icon: 'ph:github-logo-bold', text: 'KingStoning', url: 'https://github.com/KingStoning' },
			...
			},
			{
				...
				items: [
					...
					{ icon: 'ph:certificate-bold', text: '辽ICP备2024029945号', url: 'https://beian.miit.gov.cn/' },
				],
			},
		] satisfies Nav,
	},
	...
	nav: [
		{
			...
			items: [
				...
				{ icon: 'ph:tag-simple-bold', text: '标签', url: '/tag' },
